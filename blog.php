        ...
        <header>
            <div class="intro">
                ...
                <div class="head text-center">
                    ...
                    <p>
                        This blog is for people who don't like Tesla and electric cars
                    </p>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light px-5 py-3">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                      <i class="fa fa-facebook px-2 font-weight-bold" aria-hidden="true"></i>
                    </li>
                    <li class="nav-item">
                      <i class="fa fa-twitter px-2 font-weight-bold" aria-hidden="true"></i>  
                    </li>
                    <li class="nav-item">
                      <i class="fa fa-instagram px-2 font-weight-bold" aria-hidden="true"></i>
                    </li>
                    <li class="nav-item">
                      <i class="fa fa-youtube px-2 font-weight-bold" aria-hidden="true"></i>
                    </li>
                  </ul>
                </div>
              </nav>
        ...
        <section class="subscription container p-5">
            <div class="row justify-content-between align-items-center">
                <div class="content col-lg-6 col-md-6 col-12">
                    <h3>Want to get tips on which you should choose?</h3>
                    <p>Sign up and receive your suggestions</p>
                </div>
                <div class="sub col-lg-6 col-md-6 col-12">
                    <input class="py-2 px-3 col-lg-6 col-md-12 w-100 my-1"type="email" name="" placeholder="Your email">
                    <button class="text-uppercase col-lg-5 col-md-12 py-3">Subscribe</button>
                </div>
            </div>
        </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 py-5">
                            <div class="mb-5 flex-center">
                                ...
                                <a class="fb-ic">
                                    <i class="fa fa-facebook text-dark mr-4 "> </i>
                                </a>
                                <a class="tw-ic">
                                    <i class="fa fa-twitter text-dark mr-4"> </i>
                                </a>
                                <a class="ins-ic">
                                    <i class="fa fa-instagram text-dark mr-4"> </i>
                                </a>
                                <a class="li-ic">
                                    <i class="fa fa-linkedin text-dark mr-4"> </i>
                                </a>
                            </div>
                        </div>  
                    </div>
